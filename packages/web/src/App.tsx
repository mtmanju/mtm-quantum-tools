...
const tools: Tool[] = [
  ...
  { id: 'json-formatter', name: 'JSON Formatter', description: 'Format and validate JSON',
  ...
  { id: 'password-generator', name: 'Password Generator', description: 'Generate strong passwords',
  ...
  { id: 'text-case-converter', name: 'Case Converter', description: 'Convert between text cases',
  ...
  { id: 'html-formatter', name: 'HTML Formatter', description: 'Format and minify HTML',
  ...
  { id: 'sql-formatter', name: 'SQL Formatter', description: 'Format and indent SQL queries',
  ...
  { id: 'xml-formatter', name: 'XML Formatter', description: 'Format and validate XML',
  ...
  { id: 'word-counter', name: 'Word Counter', description: 'Count words, characters, and reading time',
